    ...
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('index') }}"><i
                                class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> eCommerce</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('index4') }}"><i
                                class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Cryptocurrency</a>
                    </li>
                    <li>
                        <a href="{{ route('index5') }}"><i
                                class="ri-circle-fill circle-icon text-success-main w-auto"></i> Investment</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('index7') }}"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i>
                            NFT & Gaming</a>
                    </li>
                    <li>
                        <a href="{{ route('index8') }}"><i
                                class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Medical</a>
                    </li>
                    <li>
                        <a href="{{ route('index9') }}"><i class="ri-circle-fill circle-icon text-purple w-auto"></i>
                            Analytics</a>
                    </li>
                    <li>
                        <a href="{{ route('index10') }}"><i
                                class="ri-circle-fill circle-icon text-warning-main w-auto"></i> POS & Inventory </a>
                    </li>
                </ul>
            </li> --}}
            <li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('admin.ecommerce.categories.index') }}"><i
                    ...
                    <li>
                        <a href="{{ route('admin.ecommerce.variants.index') }}"><i
                                class="ri-circle-fill circle-icon text-lilac-600 w-auto"></i> Variants</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.ecommerce.tax-rates.index') }}"><i
                                class="ri-circle-fill circle-icon text-info-main w-auto"></i> Tax Rates</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('admin.ecommerce.orders.index') }}"><i
                                class="ri-circle-fill circle-icon text-success-main w-auto"></i> Orders</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.ecommerce.order-returns.index') }}"><i
                                class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Order Returns</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('admin.ecommerce.customers.index') }}"><i
                                class="ri-circle-fill circle-icon text-info-600 w-auto"></i> Customers</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('admin.ecommerce.coupons.index') }}"><i
                                class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Coupons</a>
                    </li>
                    <li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('admin.ecommerce.notifications.index') }}"><i
                                class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Notifications</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.ecommerce.support-tickets.index') }}"><i
                                class="ri-circle-fill circle-icon text-pink w-auto"></i> Support Tickets</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.ecommerce.contact-leads.index') }}"><i
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('admin.ecommerce.blog-categories.index') }}"><i
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('blog') }}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                            Blog</a>
                    </li>
                    <li>
