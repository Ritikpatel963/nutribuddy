...
@section('content')
    ...
    <div class="card basic-data-table">
        <div class="card-header">
            <h5 class="card-title mb-0">Video Reviews Management</h5>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($review->video_path)
                                        <video src="{{ asset('storage/' . $review->video_path) }}" 
                                            class="radius-8 border object-fit-cover" 
                                            style="width: 60px; height: 106px;" controls muted preload="metadata">
                                        </video>
                                    @else
                                        <span class="text-secondary-light">No Video</span>
                                    @endif
                                </td>
                                <td>
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="form-check form-switch py-0 mb-0">
                                                <input class="form-check-input review-toggle" type="checkbox"
                                                    ...
                                                    data-id="{{ $review->id }}"
                                                    data-url="{{ route('admin.ecommerce.video-reviews.update', $review) }}"
                                ...
                                <td class="text-end">
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        <form method="POST" action="{{ route('admin.ecommerce.video-reviews.destroy', $review) }}" class="d-inline">
                                            @csrf
                                            @method('DELETE')
